        ...
        service.parseDate = function (str) {
            ...
            if (str) {
                try {
                    ...
                    try {
                        dt = new Date(str.replace(/-/g, "/").replace(/T/g, " "));
                    } catch (err) {
                        dt = new Date();
                    }
                }
            ...
            output = (dt.getMonth() + 1).toLocaleString('en-US', { minimumIntegerDigits: 2, useGrouping: false }) + '/' +
                dt.getDate().toLocaleString('en-US', { minimumIntegerDigits: 2, useGrouping: false }) + '/' +
                dt.getFullYear();
